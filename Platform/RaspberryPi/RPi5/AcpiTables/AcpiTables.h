...
#define EFI_ACPI_OEM_ID                                                        \
  { 'R', 'P', 'I', 'F', 'D', 'N' }
#define EFI_ACPI_OEM_TABLE_ID                                                  \
  SIGNATURE_64('R', 'P', 'I', '5', ' ', ' ', ' ', ' ')
...
#define QWORDMEMORY_BUF(Index, ResourceType)                                   \
  QWordMemory(ResourceType, , MinFixed, MaxFixed, NonCacheable, ReadWrite,     \
              0x0, 0x0, 0x0, 0x0, 0x1, , , RB##Index)

#define QWORDIO_BUF(Index, ResourceType)                                       \
  QWordIO(ResourceType, MinFixed, MaxFixed, PosDecode, EntireRange, 0x0, 0x0,  \
          0x0, 0x0, 0x1, , , RB##Index)

#define DWORDMEMORY_BUF(Index, ResourceType)                                   \
  DWordMemory(ResourceType, , MinFixed, MaxFixed, NonCacheable, ReadWrite,     \
              0x0, 0x0, 0x0, 0x0, 0x1, , , RB##Index)

#define WORDBUSNUMBER_BUF(Index, ResourceType)                                 \
  WordBusNumber(ResourceType, MinFixed, MaxFixed, PosDecode, 0x0, 0x0, 0x0,    \
                0x0, 0x1, , , RB##Index)
  ...
  CreateQWordField(RBUF, RB##Index._MIN, MI##Index)                            \
      CreateQWordField(RBUF, RB##Index._MAX, MA##Index)                        \
          CreateQWordField(RBUF, RB##Index._TRA, TR##Index)                    \
              CreateQWordField(RBUF, RB##Index._LEN, LE##Index) LE##Index =    \
                  Length MI##Index = Minimum TR##Index =                       \
                      Translation MA##Index = MI##Index + LE##Index - 1
  ...
  CreateDWordField(RBUF, RB##Index._MIN, MI##Index)                            \
      CreateDWordField(RBUF, RB##Index._MAX, MA##Index)                        \
          CreateDWordField(RBUF, RB##Index._TRA, TR##Index)                    \
              CreateDWordField(RBUF, RB##Index._LEN, LE##Index) LE##Index =    \
                  Length MI##Index = Minimum TR##Index =                       \
                      Translation MA##Index = MI##Index + LE##Index - 1
  ...
  CreateWordField(RBUF, RB##Index._MIN, MI##Index)                             \
      CreateWordField(RBUF, RB##Index._MAX, MA##Index)                         \
          CreateWordField(RBUF, RB##Index._TRA, TR##Index)                     \
              CreateWordField(RBUF, RB##Index._LEN, LE##Index) LE##Index =     \
                  Length MI##Index = Minimum TR##Index =                       \
                      Translation MA##Index = MI##Index + LE##Index - 1
...
#define BT_UART_BASE_ADDRESS 0x107d50c000
#define BT_UART_INTERRUPT 308
#define BT_UART_LENGTH 0x20
#define BT_UART_CLOCK_FREQUENCY 96000000

#define BCM2712_AVS_BASE 0x107d542200

#define RP1_PWM1_BASE 0x0009c000
#define RP1_PWM1_SIZE 0x00001000
